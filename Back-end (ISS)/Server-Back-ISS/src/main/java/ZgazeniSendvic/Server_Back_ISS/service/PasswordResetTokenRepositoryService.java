...
public class PasswordResetTokenRepositoryService {
    ...
    public Optional<Account> validateResetToken(String rawToken){
        ...
        Optional<PasswordResetToken> tokenFound = allResetTokens.findByTokenHash(hashedToken);
        if(tokenFound.isEmpty()){
            System.out.println("TOKEN FOUND EMPTY");
            return foundAccount;
        ...
        System.out.println("isnt found but exists");
        return foundAccount;
